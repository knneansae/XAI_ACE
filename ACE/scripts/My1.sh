...
GPU=0
OUTPUT_PATH='/content/drive/MyDrive/Colab_Notebooks/ACE'
MODELPATH='/content/drive/MyDrive/Colab_Notebooks/ACE/celebahq-ddpm.pt'
DATAPATH='/content/drive/MyDrive/Colab_Notebooks/ACE/CCKSY'
CLASSIFIERPATH="/content/drive/MyDrive/Colab_Notebooks/ACE/decision_densenet/celebamaskhq/checkpoint.tar"
